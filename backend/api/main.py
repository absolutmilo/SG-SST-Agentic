...
from api.routers import crud, procedures, auth, tasks, smart_forms, employees, autonomous_router
...
# Task management router - role-based task operations
app.include_router(
    tasks.router,
...
app.include_router(
    ...
    prefix=f"{settings.api.api_prefix}/autonomous",
