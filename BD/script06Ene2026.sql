...
-- ============================================================
-- Elimina todas las restricciones FK que apunten a nuestras tablas objetivo
-- Esto previene errores de "Referenced by FK" sin importar el nombre de la FK.
...
-- ============================================================
-- 2. LIMPIEZA DE OBJETOS (VISTAS, SPs, TABLAS)
-- ============================================================
...
-- Eliminación de tablas (Ahora segura tras eliminar FKs)
...
-- ============================================================
-- 3. CREACIÓN DE SCHEMAS CORE (SEDE, EMPLEADO COMPLETO)
-- ============================================================
...
-- EMPLEADO (Full Schema Original para compatibilidad)
...
-- ============================================================
-- 4. IMPLEMENTACIÓN RBAC Y USUARIOS (NUEVO)
-- ============================================================

CREATE TABLE [dbo].[ROL] (
    [id_rol] INT PRIMARY KEY IDENTITY(1,1),
    [Nombre] NVARCHAR(50) UNIQUE NOT NULL, -- Ej: 'SST_COORDINADOR', 'GERENTE'
...
CREATE TABLE [dbo].[PERMISO] (
    ...
    [Clave] NVARCHAR(100) UNIQUE, -- Ej: 'PERMISO_TRABAJO_APROBAR'
    [Descripcion] NVARCHAR(200)
);
GO
...
CREATE TABLE [dbo].[USUARIO] (
    ...
    [id_empleado] INT UNIQUE NOT NULL, -- Vínculo directo a la tabla EMPLEADO
...
-- ============================================================
-- 7. STORED PROCEDURES (ACTUALIZADOS)
-- ============================================================
